...
async function init() {
  ...
  function getCourseIcon(name) {
    const n = (name || "").toLowerCase();
    if (n.includes("1er") || n.includes("1ro")) return "fa-solid fa-baby";
    if (n.includes("2do")) return "fa-solid fa-user-tie";
    if (n.includes("3er") || n.includes("3ro")) return "fa-solid fa-user-secret";
    if (n.includes("4to")) return "fa-solid fa-user-ninja";
    if (n.includes("5to")) return "fa-solid fa-user-astronaut";
    if (n.includes("6to")) return "fa-solid fa-user-graduate";
